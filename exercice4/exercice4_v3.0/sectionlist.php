        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link " href="student.php">Liste des étudiants</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" href="sectionlist.php">Liste des sections</a>
                    </li>
                    <li class="nav-item">
...
<div class= "container">
<div class=" row card p-3 rounded-0"  style="border: none; background-color: rgb(242, 237, 237);"   >Liste de Section</div>
<br>
<div class="row ">
<div class="col">
<form method="post" action="">
    <input type="text" placeholder="Filtrer par nom" id="filtrerr" name="filtrerr">
    ...
    <button name="addBtn"  style="width: 20px; height: 40px;" class="btn btn-link p-0 m-0 border-0" type="submit" class="btn btn-primary ">
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($_POST['addBtn'])) {
        header(header: "Location: addSection.php?ch=" . urlencode($_POST['filtrer']));
        exit();
    }
}else{
  $ch="%%";
...
$req = $Bd->prepare( 'select * from section where Designation like ?');
    ...
    <?php foreach($rows as $row): ?>
      ...
      <tr >
        ...
        <td style="    background-color: #f8f9fa; ">
          <form action="OperationSection.php" method="post">
            ...
            <span style="visibility: hidden;">
            <?php  if($_SESSION['admin']){ echo '</span><span>';}  ?>
            <button name="suprimer" style="width: 20px; height: 40px;" 
            type="submit"class="btn btn-link p-0 m-0 border-0" >
